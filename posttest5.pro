...
write("2002002","\t ","Yulia Sugondo","\t "," Abdul Kadir","\t ","1","\t ","Jl. A. Yani No. 10 ","Klaten, ","Jawa Tengah"),nl,		%menmpilkan NIM, nama mahasiswa, Nama Dosen, Ruangan dan Alamat
write("2002003","\t ","Budiman Sejati","\t "," Abdul Kadir","\t ","1","\t ","Jl. Slamet Riyadi No. 45. ","Solo, ","Jawa Tengah"),nl.	%menmpilkan NIM, nama mahasiswa, Nama Dosen, Ruangan dan Alamat
